module Food_NFT::Food_NFT{
    ...
    public entry fun init_candy(
        ...
        move_to<Food_NFT>(&resource_signer_from_cap, Food_NFT{
            collection_name,
    ...
    public entry fun create_whitelist(
        ...
        mint_limit: u64,
        seeds:vector<u8>
    )acquires ResourceInfo,Food_NFT{
        let account_addr = signer::address_of(account);
        let resource_data = borrow_global<ResourceInfo>(Food_NFT);
        let candy_data = borrow_global_mut<Food_NFT>(Food_NFT);
    ...
    public entry fun mint_script(
        receiver: &signer,
        Food_NFT: address,
    )acquires ResourceInfo, Food_NFT,Whitelist{
        ...
        let token_data_id = token::create_token_data_id(Food_NFT,candy_data.collection_name,token_name);
    ...
    )
    {
        ...
        aptos_framework::timestamp::set_time_has_started_for_testing(Food_NFT);
    ...
    #[test(creator = @0xb0c, minter = @0xc0c, Food_NFT=@0x1,aptos_framework = @aptos_framework)]
    public entry fun test_candy_machine(
        ...
        {
            set_up_test(creator,aptos_framework,minter,Food_NFT,80);
